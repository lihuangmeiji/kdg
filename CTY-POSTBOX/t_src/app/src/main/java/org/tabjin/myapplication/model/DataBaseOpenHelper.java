...
public class DataBaseOpenHelper extends SQLiteOpenHelper {
     ...
     * Javadoc)
     *
     * @see android.database.sqlite.SQLiteOpenHelper#(android.database.sqlite
    ...
    /**
     * 将查找到的数据转换成TakeawayOrder类
     */
    private TakeawayOrderBean parseTakeawayOrder(Cursor cursor){
        TakeawayOrderBean takeawayOrderBean = new TakeawayOrderBean();
        takeawayOrderBean.setId(cursor.getInt(cursor.getColumnIndex("Id")));
        takeawayOrderBean.setBoxNo(cursor.getString(cursor.getColumnIndex("box_no")));
        takeawayOrderBean.setOpenBoxKey(cursor.getString(cursor.getColumnIndex("open_box_key")));
        takeawayOrderBean.setBox_state(cursor.getString(cursor.getColumnIndex("box_state")));
        takeawayOrderBean.setPackageNo(cursor.getString(cursor.getColumnIndex("package_no")));
        takeawayOrderBean.setTakeoutAt(cursor.getString(cursor.getColumnIndex("takeoutAt")));
        return takeawayOrderBean;
    }
